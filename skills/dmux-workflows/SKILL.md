---
name: dmux-workflows
description: 使用 dmux（AI 代理的 tmux 窗格管理器）进行多代理编排。适用于 Claude Code、Codex、OpenCode 和其他框架的并行代理工作流模式。当并行运行多个代理会话或协调多代理开发工作流时使用。
origin: ECC
---

# dmux 工作流

使用 dmux（代理框架的 tmux 窗格管理器）编排并行 AI 代理会话。
